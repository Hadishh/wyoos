...
void  VideoGraphicsArray::PutPixel(int32_t x, int32_t y, uint8_t colorIndex){
    ...
    uint8_t* pixellAddress = GetFrameBufferSegment() + y * 320 + x;
    *pixellAddress = colorIndex;
}
void VideoGraphicsArray::FillRectangle(int32_t x, int32_t y, int32_t w, int32_t h, uint8_t r, uint8_t g, uint8_t b)
{
